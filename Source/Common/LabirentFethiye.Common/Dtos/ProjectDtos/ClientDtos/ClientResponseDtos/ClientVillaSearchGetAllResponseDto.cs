...
{
    public class ClientVillaSearchGetAllResponseDto
    {
        ...
        public ICollection<ClientVillaSearchGetAllResponseDtoPhotos> Photos { get; set; }
    }

    public class ClientVillaSearchGetAllResponseDtoPhotos
    {
